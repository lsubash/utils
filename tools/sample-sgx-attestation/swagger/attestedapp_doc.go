...
//  IDReq request payload
//  swagger:parameters IDReq
type IDReq struct {
	//  in:body
	Body IdentityRequest
}

//  IDResp response payload
...
//  WrappedMsgResp response payload
//  swagger:response WrappedMsgResp
type WrappedMsgResp struct {
	//  in:body
	Body WrappedMessage
}

//  WrappedSWKResp response payload
//  swagger:response WrappedSWKResp
type WrappedSWKResp struct {
	//  in:body
	Body WrappedSWK
}

//  swagger:operation POST /wrapped_message Message httpReceiveWrappedMessage
//  ---
//  description: |
...
//  swagger:operation POST /wrapped_swk SWK httpReceiveWrappedSWK
//  ---
//  description: |
...
//  swagger:operation GET /id Identity httpGetQuotePubkey
//  ---
//  description: |
